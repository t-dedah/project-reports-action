...
describe('project-new', () => {
    ...
    it('renderMarkdown renders valid markdown', async () => {
        ...
        expect(markdown).toContain("| <img height=\"20\" width=\"20\" alt=\"@bryanmacfarlane\" src=\"https://avatars3.githubusercontent.com/u/919564?v=4\"/> <a href=\"https://github.com/bryanmacfarlane\">bryanmacfarlane</a> | [feed front project scaffolding](https://github.com/bryanmacfarlane/quotes-feed/issues/6) |");
    });    
});
