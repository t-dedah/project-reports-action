...
describe('project-new', () => {
    ...
    it('process returns NewCards', async () => {
        ...
        let processed = projectNew.process(config, projectData, drillIn) as NewCards;
    ...
    it('renderMarkdown renders valid markdown', async () => {
        ...
        expect(markdown).toContain("| <img height=\"20\" width=\"20\" alt=\"@bryanmacfarlane\" src=\"https://avatars3.githubusercontent.com/u/919564?v=4\"/> <a href=\"https://github.com/bryanmacfarlane\">bryanmacfarlane</a> | [Initial Web UI](https://github.com/bryanmacfarlane/quotes-feed/issues/13)");
    });    
});
